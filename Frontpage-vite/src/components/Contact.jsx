const Contact = () => {
  return (
    <div className=" bg-stone-300/50 h-[110vh] p-10 items-center gap-6 justify-center w-screen">
      {/* HEADING */}
      
      
      <div className="flex flex-col items-center justify-center gap-1 px-4 py-6 text-center">
        <h1 className="text-xl font-lato text-amber-500 md:text-2xl lg:text-base">
          GET IN TOUCH
        </h1>
        <h1 className="text-3x font-semibold md:text-4xl lg:text-6xl">
          Contact Us
        </h1>
      ...
      {/* INFO CARDS */}
    <div className="grid grid-cols-1 sm:grid-cols-2 pb-15 pt-5 lg:grid-cols-4 gap-6 max-w-[70%] mx-auto">
      ...
      {/* MAP */}
        ...
        <div className="h-[350px] w-[93%]  overflow-hidden max-w-[70%] mx-auto rounded-2xl md:h-[400px] lg:h-[450px]">
          <iframe
